...
{
    /*
    public static AudioManager_Old instance;
    private void Awake()
    {
    ...
    public static void Play(AudioArray sound, Vector3 position, Transform parent = null, float maxDistance = 35, AudioCategory category = AudioCategory.SFX, float volume = 1, float minPitch = DEFAULT_MIN_PITCH, float maxPitch = DEFAULT_MAX_PITCH, float _3dAmount = 1f)
    {
    ...
    public static void SetPitch(float percent0_1)
    {
        ...
        //float remapped = percent0_1 * 100f;

        //instance.masterMixer.SetFloat(PITCH_PARAM, remapped);
